...
import type { ExternalBlob as _ExternalBlob, Submission as _Submission, SubmissionId as _SubmissionId, SubmissionStatus as _SubmissionStatus, SubmitResult as _SubmitResult, Timestamp as _Timestamp, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async adminApprovePaper(arg0: SubmissionId, arg1: string): Promise<ActionResult> {
        if (this.processError) {
            try {
    ...
    async adminRejectPaper(arg0: SubmissionId, arg1: string): Promise<ActionResult> {
        if (this.processError) {
            try {
    ...
    async approvePaper(arg0: SubmissionId, arg1: string): Promise<ActionResult> {
        if (this.processError) {
            try {
    ...
    async getApprovedPapers(): Promise<Array<Submission>> {
        if (this.processError) {
            try {
    ...
    async rejectPaper(arg0: SubmissionId, arg1: string): Promise<ActionResult> {
        if (this.processError) {
            try {
    ...
    async submitPaper(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: ExternalBlob, arg5: ExternalBlob): Promise<SubmitResult> {
        if (this.processError) {
            try {
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    screenshotFileId: _ExternalBlob;
    submitterName: string;
    collegeName: string;
    submittedAt: _Timestamp;
    submitterEmail: string;
    pdfFileId: _ExternalBlob;
    submitterAge: bigint;
}): Promise<{
    id: SubmissionId;
    status: SubmissionStatus;
