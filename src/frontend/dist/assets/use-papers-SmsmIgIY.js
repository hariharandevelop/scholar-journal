...
const ActionResult = Record({
  "ok": Bool,
  "message": Text
});
const SubmissionStatus$1 = Variant({
  "pending": Null,
  "approved": Null,
  "rejected": Null
});
...
const Submission = Record({
  ...
  "screenshotFileId": ExternalBlob$1,
  "submitterName": Text,
  "collegeName": Text,
  "submittedAt": Timestamp,
  "submitterEmail": Text,
  "pdfFileId": ExternalBlob$1,
  "submitterAge": Nat
});
const SubmitResult = Variant({
  "ok": SubmissionId,
  "err": Text
});
Service({
  ...
  "adminApprovePaper": Func([SubmissionId, Text], [ActionResult], []),
  "adminLogin": Func([Text], [Bool], ["query"]),
  "adminRejectPaper": Func([SubmissionId, Text], [ActionResult], []),
  "approvePaper": Func([SubmissionId, Text], [ActionResult], []),
  "getAllSubmissions": Func([], [Vec(Submission)], ["query"]),
  "getApprovedPapers": Func([], [Vec(Submission)], ["query"]),
  "rejectPaper": Func([SubmissionId, Text], [ActionResult], []),
  "submitPaper": Func(
    [Text, Text, Nat, Text, ExternalBlob$1, ExternalBlob$1],
    [SubmitResult],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const ActionResult2 = IDL2.Record({ "ok": IDL2.Bool, "message": IDL2.Text });
  const SubmissionStatus2 = IDL2.Variant({
    "pending": IDL2.Null,
    "approved": IDL2.Null,
    "rejected": IDL2.Null
  });
  ...
  const Submission2 = IDL2.Record({
    "id": SubmissionId2,
    "status": SubmissionStatus2,
    "screenshotFileId": ExternalBlob2,
    "submitterName": IDL2.Text,
    "collegeName": IDL2.Text,
    "submittedAt": Timestamp2,
    "submitterEmail": IDL2.Text,
    "pdfFileId": ExternalBlob2,
    "submitterAge": IDL2.Nat
  });
  const SubmitResult2 = IDL2.Variant({ "ok": SubmissionId2, "err": IDL2.Text });
  return IDL2.Service({
    ...
    "adminApprovePaper": IDL2.Func(
      [SubmissionId2, IDL2.Text],
      [ActionResult2],
      []
    ),
    "adminLogin": IDL2.Func([IDL2.Text], [IDL2.Bool], ["query"]),
    "adminRejectPaper": IDL2.Func([SubmissionId2, IDL2.Text], [ActionResult2], []),
    "approvePaper": IDL2.Func([SubmissionId2, IDL2.Text], [ActionResult2], []),
    "getAllSubmissions": IDL2.Func([], [IDL2.Vec(Submission2)], ["query"]),
    "getApprovedPapers": IDL2.Func([], [IDL2.Vec(Submission2)], ["query"]),
    "rejectPaper": IDL2.Func([SubmissionId2, IDL2.Text], [ActionResult2], []),
    "submitPaper": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Nat, IDL2.Text, ExternalBlob2, ExternalBlob2],
      [SubmitResult2],
      []
    )
  });
...
class Backend {
  ...
  async adminApprovePaper(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.adminApprovePaper(arg0, arg1);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async adminRejectPaper(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.adminRejectPaper(arg0, arg1);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async approvePaper(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.approvePaper(arg0, arg1);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getApprovedPapers() {
    if (this.processError) {
      try {
        const result = await this.actor.getApprovedPapers();
        return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async rejectPaper(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.rejectPaper(arg0, arg1);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async submitPaper(arg0, arg1, arg2, arg3, arg4, arg5) {
    if (this.processError) {
      try {
        const result = await this.actor.submitPaper(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n14(this._uploadFile, this._downloadFile, arg4), await to_candid_ExternalBlob_n14(this._uploadFile, this._downloadFile, arg5));
...
function from_candid_SubmissionStatus_n11(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
async function from_candid_Submission_n9(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n10(_uploadFile, _downloadFile, value);
}
function from_candid_SubmitResult_n15(_uploadFile, _downloadFile, value) {
...
async function from_candid_record_n10(_uploadFile, _downloadFile, value) {
  return {
    ...
    screenshotFileId: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.screenshotFileId),
    submitterName: value.submitterName,
    collegeName: value.collegeName,
    submittedAt: value.submittedAt,
    submitterEmail: value.submitterEmail,
    pdfFileId: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.pdfFileId),
    submitterAge: value.submitterAge
  };
}
...
export {
  SubmissionStatus as S,
  useApprovedPapers as a,
  useAdminLogin as b,
  useAllSubmissions as c,
  useAdminApprove as d,
  useAdminReject as e,
  useSubmitPaper as u
};
